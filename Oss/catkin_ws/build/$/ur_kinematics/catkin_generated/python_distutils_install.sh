...
echo_and_run cd "/home/tommaso/catkin_ws/src/$/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/tommaso/catkin_ws/src/$/ur_kinematics/setup.py" \
     \
    build --build-base "/home/tommaso/catkin_ws/build/$/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
